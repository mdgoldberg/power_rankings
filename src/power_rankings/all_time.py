...
def main(
    ...
    if base_filename is None and not auto_fetch:
        cli_common.abort("Provide base_filename or omit --offline to auto-fetch schedules.", exit_code=2)
    if auto_fetch and league_id is None and league is None:
        cli_common.abort("Provide --league-id or --league when auto-fetching schedules.", exit_code=2)
